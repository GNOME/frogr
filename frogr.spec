...
BuildRequires:	gtk2-devel > 2.14, libsoup-devel > 2.24, libxml2-devel > 2.6.8, libexif-devel > 0.6.14
Requires:	gtk2 > 2.14, libsoup, libxml2, libexif, gvfs, desktop-file-utils
