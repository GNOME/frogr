...
typedef enum {
  ...
  FSP_ERROR_ALREADY_IN_PHOTOSET,

  FSP_ERROR_GROUP_NOT_FOUND,
  FSP_ERROR_ALREADY_IN_GROUP,
  FSP_ERROR_PHOTO_IN_MAX_NUM_GROUPS,
  FSP_ERROR_GROUP_LIMIT_REACHED,
  FSP_ERROR_PHOTO_ADDED_TO_GROUP_QUEUE,
  FSP_ERROR_PHOTO_ALREADY_IN_GROUP_QUEUE,
